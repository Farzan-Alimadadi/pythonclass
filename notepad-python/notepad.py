...
class Notepads_managment:
    def __init__(self, top=None):
        ...
        self.TNotebook1.tab(3, text="Delete",compound="none",underline="-1",)
        ...
        self.inputTitle2 = Entry(self.TNotebook1_t0)
        self.inputTitle2.place(relx=0.09, rely=0.15,height=20, relwidth=0.6)
        self.inputTitle2.configure(background="white")
        self.inputTitle2.configure(font="TkFixedFont")
        self.inputTitle2.configure(selectbackground="#c4c4c4")
        ...
        self.Label1_1 = Label(self.TNotebook1_t0)
        self.Label1_1.place(relx=0.02, rely=0.15, height=18, width=29)
        self.Label1_1.configure(activebackground="#f9f9f9")
        self.Label1_1.configure(text='''Title2''')
        ...
        self.Label3_1 = Label(self.TNotebook1_t1)
        self.Label3_1.place(relx=0.02, rely=0.15, height=18, width=29)
        self.Label3_1.configure(activebackground="#f9f9f9")
        self.Label3_1.configure(text='''Title2''')
        ...
        # Delete button that clears the title field
        self.Button9 = Button(self.TNotebook1_t0)
        self.Button9.place(relx=0.74, rely=0.49, height=26, width=56)
        self.Button9.configure(activebackground="#d9d9d9")
        self.Button9.configure(text='''Delete''')
        self.Button9.bind('<Button-1>',lambda e:notepad_support.deleteTitle_button(e))
